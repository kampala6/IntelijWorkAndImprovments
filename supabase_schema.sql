-- Schema for insurance model classes.
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_bilforsikring_registreringsnummer
    ON bilforsikring(registreringsnummer);
CREATE INDEX IF NOT EXISTS ix_bilforsikring_kunde_nr
    ON bilforsikring(kunde_nr);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_baatforsikring_registreringsnummer
    ON baatforsikring(registreringsnummer);
CREATE INDEX IF NOT EXISTS ix_baatforsikring_kunder
    ON baatforsikring(kunder);
...
CREATE INDEX IF NOT EXISTS ix_husoginnboforsikring_kunde
    ON husoginnboforsikring(kunde);
...
CREATE INDEX IF NOT EXISTS ix_skade_melding_kunde_nr
    ON skade_melding(kunde_nr);
...
ALTER TABLE kunde
    ADD CONSTRAINT fk_kunde_primary_bil
    FOREIGN KEY (primary_bil_forsikring_id)
    REFERENCES bilforsikring(forsikring_id)
    ON DELETE SET NULL;
